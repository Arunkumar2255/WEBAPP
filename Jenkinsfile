pipeline {
    ...
    stages {
        ...
        stage('Sonarqube Analysis') {
            steps {
                sh '''
                $SCANNER_HOME/bin/sonar-scanner -Dsonar.host.url=http://13.201.134.113:9000/ -Dsonar.login=squ_385a453cdf3c2d510c66a2093be3be53e23ecf93 -Dsonar.projectName=nodejs-app \
                -Dsonar.sources=. \
